...
Route::group([
    ...
    Route::post('/decks/procura_carta', [\App\Http\Controllers\DeckController::class, 'procuraCarta'])->name('decks.procura_carta');
    Route::post('/decks/adiciona_carta', [\App\Http\Controllers\DeckController::class, 'adicionaCarta'])->name('decks.adiciona_carta');
    ...
    Route::post('/decks/deleta-carta', [\App\Http\Controllers\DeckController::class, 'deletaCarta'])->name('decks.deleta_carta');
